...
var object_cache_1 = __webpack_require__(0);
var CacheLoader = __webpack_require__(6);
...
var object_cache_1 = __webpack_require__(0);
exports.DEFAULT_CACHE_KEY_NAME = 'shopify_js_cache';
function restoreCache(key, opts) {
    if (key === void 0) { key = exports.DEFAULT_CACHE_KEY_NAME; }
    return localForage.getItem(key).then(function (result) {
        if (!result)
            return result;
        return new object_cache_1.ObjectCache(opts, result);
    });
}
exports.restoreCache = restoreCache;
function writeCache(cache, key) {
    if (key === void 0) { key = exports.DEFAULT_CACHE_KEY_NAME; }
