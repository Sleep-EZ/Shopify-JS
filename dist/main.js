...
exports.clean_expired = clean_expired;
...
var Client = /** @class */ (function () {
    ...
    function Client(options) {
        var urlRegex = /([a-z0-9|-]+\.)*[a-z0-9|-]+\.[a-z]+/i;
