...
export interface Indexable { id: number; }
...
export interface CartLineItem<ID extends number> extends Expires {
  ...
  // TODO: Determine the proper type for this value. Was unable to get any
  // value to appear here (even with a coupon code applied to the cart).
  discounts: string[];
  gift_card: boolean;
  grams: number;
  handle: Handle;
