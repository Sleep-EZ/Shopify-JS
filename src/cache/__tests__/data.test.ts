import { Cache, indexSingleElement, generateEmptyCacheData, CacheData$Values, rebuildCache } from "../index";
import { ShopifyTypeEnum } from "../../types";
import { testCreatePage, testCreateVariant, testCreateProduct } from "../../testing/index";
...
describe('CacheData', () => {
    ...
    describe('indexSingleElement()', () => {
        ...
        it('SPECIAL: Indexing handle resolves proper ID', () => {
            ...
            expect(cache._cache.handles[ShopifyTypeEnum.Page]).toEqual({
                happy: 1,
                sad: 0
            });
        });
